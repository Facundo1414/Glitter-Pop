...
export default function Contact() {
  ...
  return (
    <section id="contacto" className="py-16 md:py-20 bg-gradient-to-br from-pastel-lavender via-pastel-pink to-pastel-peach relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-center mb-3 md:mb-4 text-gray-800 drop-shadow-sm px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          ...
          <div className="text-gray-800 space-y-6 md:space-y-8">
            <div>
              ...
              <div className="space-y-5 md:space-y-6 px-4 lg:px-0">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <div className="font-semibold mb-2 text-gray-800 text-sm sm:text-base">WhatsApp (Preferido)</div>
                    <a 
                      href={`https://wa.me/${business.whatsapp}?text=Hola! Me gustaría consultar sobre sus servicios`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-green-500 hover:bg-green-600 active:bg-green-700 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold inline-flex items-center gap-2 transition-all hover:scale-105 active:scale-95 touch-manipulation text-sm sm:text-base"
                    >
                      💬 Escribinos ahora
                    </a>
                  </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-white/70 rounded-full p-2 sm:p-3 backdrop-blur-sm shadow-md shrink-0">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-white/70 rounded-full p-2 sm:p-3 backdrop-blur-sm shadow-md shrink-0">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white/50 rounded-xl md:rounded-2xl p-5 sm:p-6 backdrop-blur-sm shadow-md mx-4 lg:mx-0">
              <h4 className="text-lg sm:text-xl font-bold mb-3 text-gray-800">Disponibilidad</h4>
