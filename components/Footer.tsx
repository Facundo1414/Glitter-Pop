        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-3 md:space-x-4">
              <Button asChild variant="ghost" size="icon" className="bg-gray-800 rounded-full p-2.5 md:p-3 w-auto h-auto hover:bg-pastel-lavender active:bg-pastel-lavender/80 hover:scale-110 active:scale-95">
                <a
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-display font-bold text-base md:text-lg mb-3 md:mb-4">Enlaces Rápidos</h3>
