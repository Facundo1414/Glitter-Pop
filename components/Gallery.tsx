        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-5 md:gap-8 max-w-6xl mx-auto">
            {videoExamples.map((video, index) => (
              ...
              >
                <Card className="overflow-hidden hover:shadow-2xl active:scale-98 transition-all duration-300 touch-manipulation border-none shadow-xl">
                  ...
                  <CardContent className="p-4 sm:p-5 text-center bg-gradient-to-b from-white to-gray-50">
          ...
          style={{ transitionDelay: '600ms' }}>
            ...
            <Button variant="link" asChild className="text-pastel-purple font-semibold hover:text-primary-600 active:scale-95 touch-manipulation gap-2">
              <a
