...
export default function Gallery() {
  ...
  return (
    <section id="galeria" className="py-20 bg-gradient-to-b from-pastel-blue/10 to-white">
        ...
        <div>
          <div className={`text-center mb-12 transition-all duration-1000 ${
            ...
            <h2 className="text-4xl md:text-5xl font-display font-bold text-gray-900 mb-4">
              Videos & <span className="text-pastel-pink">Reels</span>
            </h2>
              ...
              >
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="p-5 text-center bg-gradient-to-b from-white to-gray-50">
                    <h3 className="font-display font-bold text-gray-900 mb-2 text-lg">{video.title}</h3>
          ...
          style={{ transitionDelay: '600ms' }}>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-pastel-purple font-semibold hover:text-primary-600 transition-colors"
            >
