...
export default function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-pastel-lavender via-pastel-pink to-pastel-peach pt-20 md:pt-24"
    >
          ...
          <div className="text-center lg:text-left space-y-3 md:space-y-4">
            ...
            <div className="flex justify-center lg:justify-start animate-fade-in">
              <div className="relative group">
                <div className="absolute -inset-4 bg-gradient-to-r from-pastel-lavender via-pastel-pink to-pastel-peach rounded-full opacity-30 blur-3xl group-hover:opacity-60 transition-all duration-700 animate-pulse-slow"></div>
                <div className="relative">
                  <Image
                    ...
                    width={350}
                    height={120}
                    className="h-12 md:h-20 lg:h-24 w-auto object-contain drop-shadow-2xl hover:scale-110 transition-transform duration-500"
                    priority
                  />
                </div>
              </div>
            ...
            <div className="space-y-1.5 md:space-y-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl text-gray-800 font-bold font-display leading-tight px-2 sm:px-0">
                {business.tagline}
              </h1>
            ...
            {/* Description */}
            <p className="text-xs sm:text-sm md:text-base lg:text-base text-gray-700 leading-relaxed max-w-xl mx-auto lg:mx-0 animate-fade-in px-6 sm:px-4 md:px-0" style={{ animationDelay: '0.4s' }}>
              {business.description}
            </p>
            
            {/* CTA Buttons con diseño mejorado */}
            <div className="flex flex-col sm:flex-row gap-2 md:gap-3 justify-center lg:justify-start animate-fade-in px-6 sm:px-4 md:px-0" style={{ animationDelay: '0.6s' }}>
              <Link
                href="/contacto"
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 pt-3 md:pt-4 animate-fade-in px-2 sm:px-0" style={{ animationDelay: '0.8s' }}>
              <div className="text-center lg:text-left group hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-pastel-lavender to-pastel-pink bg-clip-text text-transparent">
                  500+
                </div>
                <div className="text-[9px] sm:text-[10px] md:text-xs text-gray-700 font-medium leading-tight">Eventos Realizados</div>
              </div>
              ...
              <div className="text-center lg:text-left group hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-[9px] sm:text-[10px] md:text-xs text-gray-700 font-medium leading-tight">Calificación</div>
              </div>
              ...
              <div className="text-center lg:text-left group hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-[9px] sm:text-[10px] md:text-xs text-gray-700 font-medium leading-tight">Clientes Felices</div>
              </div>
            </div>
          </div>
